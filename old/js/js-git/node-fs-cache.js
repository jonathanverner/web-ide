define(function (require, exports, module) {var encoders = require('../lib/encoders.js');
...
module.exports = function (root) {
  ...
  function toPath(type, hash) {
    if (!type || !hash) throw new TypeError("type and hash required");
